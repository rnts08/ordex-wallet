...
### Run Tests
```bash
cd /home/timh/Projects/ordex-wallet/ordex-web-wallet/backend
...
### Start Services
```bash
cd /home/timh/Projects/ordex-wallet/ordex-web-wallet/docker
...
python scripts/reset_env.py --force

# Reset only wallets and admin (keep database)
python scripts/reset_env.py --keep-db --force
```
...
## Agent vocabulary and execution

- No articles
- No fillers
- No pleasantries
- No hedging
- Technical vocabulary remains exact
